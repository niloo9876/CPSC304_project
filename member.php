...
<p><table>
  <tr>
    <td><font size="2">My Member ID:</font></td>
    <td><font size="2">My friend's Member ID:</font></td>
    </tr>
  <tr>
    <td><input type="text" name="MyMID" size="20"></td>
    <td><input type="text" name="FriendMID" size="20"></td>
  </tr>
  <tr>
...
<form method="POST" action="member.php">
    ...
    <p><table>
        <tr>
            <td><font size="2">My ID</font></td>
        </tr>
        <tr>
            <td><input type="text" name="MyID" size="30"></td>
        </tr>
        <tr>
